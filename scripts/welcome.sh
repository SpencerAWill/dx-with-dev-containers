...
echo -e "  \033[1mStatus page:\033[0m    http://localhost:5173/status"
echo -e "  \033[1mAPI reference:\033[0m  http://localhost:5000/scalar"
echo -e "  \033[1mMobile (Expo):\033[0m  cd apps/mobile && pnpm tunnel  (scan QR in Expo Go)"
echo ""
